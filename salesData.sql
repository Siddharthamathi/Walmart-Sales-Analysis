...
WHERE branch = "C" GROUP BY gender ORDER BY gender_cnt DESC;
...
WHERE branch = "C" GROUP BY day_name ORDER BY total_sales DESC;

--Sales-related questions
-- Number of sales made in each time of the day per weekday 
SELECT time_of_day, COUNT(*) AS total_sales FROM sales
WHERE day_name = "Sunday" GROUP BY time_of_day ORDER BY total_sales DESC;
